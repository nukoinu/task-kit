...
## 手順
1. 添付テンプレート(#.task-kit/current-task.md, #.task-kit/templates/tasks/task.md, #.task-kit/templates/tasks/records/findings.md)を参照し、タスクパスを確定する。未指定時は `.task-kit/current-task.md` のタスクパスを使う。
...
6. 変更履歴に更新内容を追記する。
7. 変更の過程で新しい事実や知見を発見した場合のみ、records/findings.md に要約と根拠を記録する。
