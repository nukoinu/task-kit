...
## 手順
1. 添付テンプレート(#.task-kit/current-task.md, #.task-kit/templates/tasks/plan.md, #.task-kit/templates/tasks/records/findings.md, #.task-kit/templates/tasks/records/scratchpad.md, #.task-kit/templates/tasks/outputs/.gitkeep)を参照し、タスクパスを確定する。未指定時は `.task-kit/current-task.md` のタスクパスを使う。
