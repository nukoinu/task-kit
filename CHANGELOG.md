...
- `task-kit lint` が markdownlint-cli2 の公開エントリポイントを正しく解決できず、依存関係がないと誤判定する問題を修正した。

## [0.5.3] - 2026-07-22

### 追加

- Node.js 22 環境で JavaScript の構文チェック、Markdown lint、テストを自動実行する CI ワークフローを追加した。

### 変更

- Markdown lint 設定とエージェント開発ガイドを更新した。
